...
public class Aodb2IbAdapterRouteTest extends CamelTestSupport {
    ...
    protected CamelContext createCamelContext() throws Exception {
    	...
    	mqifMessageProcessor.setXmlTransformer(xmlTransformer);
    	mqifMessageProcessor.setXmlDepatureTransformer(xmlDepatureTransformer);
        return camelContext;
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
            	from("jmsaodb:AQ.AODB.IB_SS1BOLO").wireTap("jmsib:AQ.AODBLOG").split().method(mqifMessageProcessor, "processMqif")
