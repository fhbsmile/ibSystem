/**
 * Project	 ibSystem
 * Package   com.tsystems.si.aviation.imf.ibSystem.adapter.fss2
 * FileName  FSS2Aodb2ibMessageProcesser.java
 * Description TODO
 * Company	
 * Copyright 2017 
 ...
 * Createdate 2017年7月22日 下午5:01:19
 *
...
/**
  * ClassName FSS2Aodb2ibMessageProcesser<BR>
  * Description TODO<BR>
  * @author Bolo Fang
  * @date 2017年7月22日 下午5:01:19
  *
  */

public class FSS2Aodb2ibMessageProcesser implements MessageProcesser {
	private static final Logger     logger               = LoggerFactory.getLogger(FSS2Aodb2ibMessageProcesser.class);
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月22日 下午5:01:19<BR></p>
	  * @param message
	  * @return FSS2Aodb2ibMessageProcesser
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月22日 下午5:01:19<BR></p> FSS2Aodb2ibMessageProcesser
