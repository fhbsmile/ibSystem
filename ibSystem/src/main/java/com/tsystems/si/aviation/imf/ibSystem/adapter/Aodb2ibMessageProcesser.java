 ...
 * FileName  Aodb2ibMessageProcesser.java
 * Description TODO
 * Company	
 * Copyright 2017 
 ...
 * Createdate 2017年7月5日 下午3:05:59
 *
...
/**
  * ClassName Aodb2ibMessageProcesser<BR>
  * Description TODO<BR>
  * @author Bolo Fang
  * @date 2017年7月5日 下午3:05:59
  *
  */

public class Aodb2ibMessageProcesser implements MessageProcesser {
	private static final Logger     logger               = LoggerFactory.getLogger(Aodb2ibMessageProcesser.class);
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月5日 下午3:05:59<BR></p>
	  * @param message
	  * @return Aodb2ibMessageProcesser
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月12日 上午10:54:07<BR></p> MessageProcesser
