 ...
 * FileName  ImfMessageProcessor.java
 * Description TODO
 * Company	
 * Copyright 2017 
...
/**
  * ClassName ImfMessageProcessor<BR>
  * Description TODO<BR>
  * @author Bolo Fang
...
public class ImfMessageProcessor implements Processor {
	private static final Logger     logger               = LoggerFactory.getLogger(ImfMessageProcessor.class);
	...
	/**
	  ...
	  * @param exchange
	  * @throws Exception ImfMessageProcessor
