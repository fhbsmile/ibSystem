/**
 * Project	 ibSystem
 * Package   com.tsystems.si.aviation.imf.ibSystem.adapter.rss2
 * FileName  RSS2Aodb2ibMessageProcesser.java
 * Description TODO
 * Company	
 * Copyright 2017 
 ...
 * Createdate 2017年7月22日 下午5:01:31
 *
...
/**
  * ClassName RSS2Aodb2ibMessageProcesser<BR>
  * Description TODO<BR>
  * @author Bolo Fang
  * @date 2017年7月22日 下午5:01:31
  *
  */

public class RSS2Aodb2ibMessageProcesser implements MessageProcesser {
	private static final Logger     logger               = LoggerFactory.getLogger(RSS2Aodb2ibMessageProcesser.class);
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月22日 下午5:01:31<BR></p>
	  * @param message
	  * @return RSS2Aodb2ibMessageProcesser
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月22日 下午5:01:31<BR></p> RSS2Aodb2ibMessageProcesser
