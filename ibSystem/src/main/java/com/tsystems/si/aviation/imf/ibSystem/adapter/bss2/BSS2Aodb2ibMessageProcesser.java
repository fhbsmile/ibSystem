/**
 * Project	 ibSystem
 * Package   com.tsystems.si.aviation.imf.ibSystem.adapter.bss2
 * FileName  BSS2Aodb2ibMessageProcesser.java
 * Description TODO
 * Company	
 * Copyright 2017 
 ...
 * Createdate 2017年7月22日 下午5:00:05
 *
...
/**
  * ClassName BSS2Aodb2ibMessageProcesser<BR>
  * Description TODO<BR>
  * @author Bolo Fang
  * @date 2017年7月22日 下午5:00:05
  *
  */

public class BSS2Aodb2ibMessageProcesser implements MessageProcesser {
	private static final Logger     logger               = LoggerFactory.getLogger(BSS2Aodb2ibMessageProcesser.class);
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月22日 下午5:00:05<BR></p>
	  * @param message
	  * @return BSS2Aodb2ibMessageProcesser
	...
	/**
	  ...
	  * Description:<BR>
	  * Overriding_Date: 2017年7月22日 下午5:00:05<BR></p> BSS2Aodb2ibMessageProcesser
