...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/" xmlns:aodb="urn:com.tsystems.ac.aodb"
	...
	<xsl:template match="/">
		...
		<IMFRoot>
			...
			<xsl:variable name="imfServiceType" select="javacode:getImfServiceTypeByMqif($aodbMessageType,$aodbOrgMessageType,$aodbDataType,$aodbBodyDataType,$aodbCorrelationId)"></xsl:variable>
