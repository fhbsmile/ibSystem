<!-- Version 2.0j 2014-06-23 mod by zzhao mod mapping rule of "flightnumber"; Version 2.0i 2014-05-27 mod by zzhao add node mapping of "CreateReason";
	...
	Version 2.0f 2014-05-16 mod by zzhao add mapping rule for node "DiversionAirport/AirportIATACode",node "DiversionAirport/AirportICAOCode", node "ChangeLandingAirport/AirportIATACode" 
	and node "ChangeLandingAirport/AirportICAOCode";
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/" xmlns:aodb="urn:com.tsystems.ac.aodb"
	...
	<xsl:template match="/">
		...
		<IMFRoot>
			...
			<xsl:variable name="imfServiceType"
				select="javacode:getImfServiceTypeByMqif($aodbMessageType,$aodbOrgMessageType,$aodbBodyDataType,$aodbBodyDataType,$aodbCorrelationId)"></xsl:variable>
									...
									<FlightData>
										<General>
											...
											<FlightServiceType>
												<FlightIATAServiceType>
													<xsl:call-template name="xsltTemplate">
														<xsl:with-param name="inElement" select="/soap-env:Envelope/soap-env:Body/pl_turn/pt_pd_departure/pl_departure/pd_rstc_servicetypecode" />
														<xsl:with-param name="needAddNil" select="false()" />
													</xsl:call-template>
												</FlightIATAServiceType>
											</FlightServiceType>
											<FlightRoute>
												<IATARoute>
													...
													<IATANextAirport>
														<xsl:call-template name="xsltTemplate">
															<xsl:with-param name="inElement" select="pd_rap_nextairport" />
															<xsl:with-param name="needAddNil" select="false()" />
														</xsl:call-template>
													</IATANextAirport>
													<IATADestinationAirport>
														<xsl:call-template name="xsltTemplate">
															<xsl:with-param name="inElement" select="pd_rap_destinationairport" />
															<xsl:with-param name="needAddNil" select="false()" />
														</xsl:call-template>
													</IATADestinationAirport>
												</IATARoute>
												<ICAORoute>
													<ICAOFullRoute>
														<xsl:for-each select="pl_routing_list/pl_routing">
															...
															<xsl:variable name="viaAirport" select="prt_rap_refairport.ref_airport.rap_icao4lc" />
															<AirportICAOCode>
																<xsl:attribute name="LegNo"><xsl:value-of select="$legNo" /></xsl:attribute>
																<!--oldvalue1 -->
													...
													<ICAONextAirport>
														<xsl:call-template name="xsltTemplate">
															<xsl:with-param name="inElement" select="pd_rap_nextairport/ref_airport/rap_icao4lc" />
															<xsl:with-param name="needAddNil" select="false()" />
														</xsl:call-template>
													</ICAONextAirport>
													<ICAODestinationAirport>
														<xsl:call-template name="xsltTemplate">
															<xsl:with-param name="inElement" select="pd_rap_destinationairport/ref_airport/rap_icao4lc" />
															<xsl:with-param name="needAddNil" select="false()" />
														</xsl:call-template>
													</ICAODestinationAirport>
												</ICAORoute>
											...
											<FlightCountryType>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement" select="pd_rctt_countrytype/ref_countrytype" />
													<xsl:with-param name="needAddNil" select="false()" />
												</xsl:call-template>
											</FlightCountryType>
											<xsl:choose>
																...
																<xsl:when test="pa_sibt">
																	<FlightScheduledDate>
																		...
																		<xsl:if test="pa_sibt/@old">
																			<xsl:attribute name="OldValue"><xsl:value-of select="pa_sibt/@old" />
															</xsl:attribute>
																		</xsl:if>
																	...
																	<DetailedIdentity>
																		<AirlineIATACode>
																			<xsl:call-template name="xsltTemplate">
																				<xsl:with-param name="inElement" select="pa_ral_airline/ref_airline/ral_2lc" />
																				<xsl:with-param name="needAddNil" select="false()" />
																			</xsl:call-template>
																		</AirlineIATACode>
																		<AirlineICAOCode>
																			<xsl:call-template name="xsltTemplate">
																				<xsl:with-param name="inElement" select="pa_ral_airline/ref_airline/ral_3lc" />
																				<xsl:with-param name="needAddNil" select="false()" />
																			</xsl:call-template>
																		</AirlineICAOCode>
																	</DetailedIdentity>
																	<InternalID>
																		<xsl:value-of select="normalize-space(/soap-env:Envelope/soap-env:Body/pl_turn/pt_pa_arrival/pl_arrival/pa_idseq)" />
																	</InternalID>
																</xsl:when>
															</xsl:choose>
														</xsl:for-each>
										...
										<Status>
											...
											<DelayReason>
												...
												<DelayFreeText>
													<xsl:call-template name="xsltTemplate">
														<xsl:with-param name="inElement" select="pl_delayreason_list/pl_delayreason/pdlr_pdlr_comment1" />
														<xsl:with-param name="needAddNil" select="false()" />
													</xsl:call-template>
												</DelayFreeText>
											</DelayReason>
											...
											<IsOverNightFlight>
												<xsl:variable name="paSibt" select="substring('/soap-env:Envelope/soap-env:Body/pl_turn/pt_pa_arrival/pl_arrival/pa_sibt',1,10)"></xsl:variable>
												<xsl:variable name="pdSobt" select="substring('/soap-env:Envelope/soap-env:Body/pl_turn/pt_pa_arrival/pl_arrival/pd_sobt',1,10)"></xsl:variable>
												<xsl:choose>
										...
										<Airport>
																...
																<StandID>
																	<xsl:call-template name="updateStandID">
																		...
																		<xsl:with-param name="ref_standid"
																			select="/soap-env:Envelope/soap-env:Body/pl_turn/pt_pd_departure/pl_departure/pd_rsta_refstand/ref_stand/rsta_code" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</StandID>
													...
													<xsl:when test="pl_departurebelt">
														<xsl:for-each select="pl_departurebelt">
															<BaggageMakeup>
																<BaggageBeltID>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdb_rdb_departurebelt" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</BaggageBeltID>
																<BaggageBeltStatus>
											...
											<xsl:for-each select="pl_departuregate_list">
												<xsl:choose>
														...
														<xsl:for-each select="pl_specialservice">
															<SpecialService>
																...
																<SpecialServiceResourceType>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pss_rsc_service/ref_servicecatalog/rsc_resourcetype" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</SpecialServiceResourceType>
																<SpecialServiceResourceID>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pss_rsc_service/ref_servicecatalog/rsc_resourceid" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</SpecialServiceResourceID>
																<SpecialServiceResourceDescription>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pss_rsc_service/ref_servicecatalog/rsc_description" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</SpecialServiceResourceDescription>
																<SpecialServiceResourceUnit>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pss_rsc_service/ref_servicecatalog/rsc_unit" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</SpecialServiceResourceUnit>
															</SpecialService>
										...
										<DeparturePlanningInformation>
											<xsl:for-each select="pl_dpi_list">
												<xsl:choose>
													<xsl:when test="pl_dpi">
														<xsl:for-each select="pl_dpi">
															<DPI>
																<DPIID>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_idseq" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</DPIID>
																<DPIStatus>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_dpistatus" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIStatus>
																<DPISendIndicator>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_sendind" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPISendIndicator>
																<DPIAtcDeparture>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_pad_atcdeparture" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</DPIAtcDeparture>
																<DPIDeparture>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_pd_departure" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</DPIDeparture>
																<DPIDepartureStatus>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_depstatus" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIDepartureStatus>
																<DPIDepartureReason>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_depreason" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIDepartureReason>
																<DPICallSign>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_callsign" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPICallSign>
																<DPIAircraft>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_rac_aircraft" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIAircraft>
																<DPIDestinationAirport>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_rap_destairport" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIDestinationAirport>
																<DPIFlightRoute>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_flightroute" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIFlightRoute>
																<DPIRule>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_rule" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</DPIRule>
																<DPIExot>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_exot" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</DPIExot>
																<DPISobt>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_sobt" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPISobt>
																<DPIEobt>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_eobt" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIEobt>
																<DPIAobt>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_aobt" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPIAobt>
																<DPITsat>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_tsat" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPITsat>
																<DPITobt>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_tobt" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPITobt>
																<DPITtot>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_ttot" />
																		<xsl:with-param name="needAddNil" select="true()" />
																	</xsl:call-template>
																</DPITtot>
																<DPIText>
																	<xsl:call-template name="xsltTemplate">
																		<xsl:with-param name="inElement" select="pdpi_text" />
																		<xsl:with-param name="needAddNil" select="false()" />
																	</xsl:call-template>
																</DPIText>
															</DPI>
