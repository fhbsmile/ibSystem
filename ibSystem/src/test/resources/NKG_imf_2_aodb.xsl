...
Version 2.0k 2014-05-19 mod by zzhao change mapping rule of "EstimatedOffBlockDateTime" from "pd_eobt"  to "pd_eobtlocal" and "ActualOffBlockDateTime" from "pd_eobtlocal" to "pd_aobt";
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:aodb="urn:com.tsystems.ac.aodb"
		...
		<soap-env:Envelope xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/"
			...
			<soap-env:Header>
				<aodb:control>
					<xsl:for-each select="IMFRoot/SysInfo">
						...
						<xsl:if
							test="(ServiceType='FSS1' or ServiceType='BSS1' or ServiceType='RSS1' or ServiceType='GSS1') and ../Operation/Subscription ">
							<aodb:message-type>SUBSCRIBE</aodb:message-type>
						</xsl:if>
						<xsl:if
							test="(ServiceType='FSS1'  or ServiceType='BSS1' or ServiceType='RSS1' or ServiceType='GSS1') and ../Operation/Unsubscription">
							<aodb:message-type>UNSUBSCRIBE</aodb:message-type>
						</xsl:if>
						<xsl:if
							test="ServiceType='FSS2' or ServiceType='BSS2' or ServiceType='RSS2' or ServiceType='GSS2'">
							<aodb:message-type>DATASET</aodb:message-type>
						</xsl:if>
						<xsl:if
							test="ServiceType='FUS' or ServiceType='RUS' or ServiceType='GUS' or ServiceType='FRS'">
							<aodb:message-type>UPDATE</aodb:message-type>
						</xsl:if>
						<xsl:if test="ServiceType!='FRS'">
							<aodb:request>
								<xsl:if
									test="ServiceType='FSS1' or ServiceType='FSS2' or ServiceType='FUS'">
								...
								<xsl:if
									test="ServiceType='GSS1' or ServiceType='GSS2' or ServiceType='GUS'">
								...
								<xsl:if
									test="../Operation/Subscription/SyncPeriodRequest/SyncUpdateFromDateTime">
									<aodb:modification-start-time>
								...
								-->
								<xsl:if
									test="../Operation/Subscription/FlightPeriodRequest/FlightScheduleFromDateTime">
									<aodb:start-time>
										<xsl:value-of select="$schstarttime" />
									</aodb:start-time>
								</xsl:if>
								<xsl:if
									test="../Operation/Subscription/FlightPeriodRequest/FlightScheduleEndDateTime">
									<aodb:end-time>
								...
								<xsl:if test="ServiceType='FSS2'">
									<aodb:datasetquery>
										<xsl:if test="../Data/FlightData/Airport/Terminal/FlightTerminalID">
											...
											<xsl:variable name="terminalPrefix">pl_arrival.pa_rtrm_terminal,pl_departure.pd_rtrm_terminal</xsl:variable>
											<xsl:variable name="tidCondition" select="javacode:buildRequestFilter($terminalId, $terminalPrefix)" />
											<xsl:value-of select="$tidCondition" /> and 
										</xsl:if>
										<xsl:if test="../Data/PrimaryKey/FlightKey/DetailedIdentity/AirlineIATACode">
											...
											<xsl:variable name="iataPrefix">pl_arrival.pa_ral_airline,pl_departure.pd_ral_airline</xsl:variable>
											<xsl:variable name="iataCondition" select="javacode:buildRequestFilter($iataCode, $iataPrefix)" />
											<xsl:value-of select="$iataCondition" /> and 
										</xsl:if>
										<xsl:if test="../Data/PrimaryKey/FlightKey/FlightDirection">
											...
											<xsl:if test="$direction='A'">pl_arrival.pa_ral_airline is not null</xsl:if>
											<xsl:if test="$direction='D'">pl_departure.pd_ral_airline is not null</xsl:if> and
										</xsl:if>
										<xsl:if test="../Data/FlightData/General/FlightServiceType">
											...
											<xsl:variable name="stPrefix">pl_arrival.pa_rstc_servicetypecode,pl_departure.pd_rstc_servicetypecode</xsl:variable>
											<xsl:variable name="stCondition" select="javacode:buildRequestFilter($st, $stPrefix)" />
											<xsl:value-of select="$stCondition" /> and 
										</xsl:if>(1 = 1)
			...
			<soap-env:Body>
				<xsl:if test="IMFRoot/Data and $st!='FSS1' and $st!='FSS2' and $st!='RSS1' and $st!='RSS2'">
					<xsl:variable name="arrivalOrDepature"
						...
						<xsl:if test="PrimaryKey/FlightKey">						
							<pl_turn>
							 <xsl:call-template name="actionMode">
								...
								<xsl:if
									test="$arrivalOrDepature='Arrival' or $arrivalOrDepature='A' ">
									<pt_pa_arrival>
										...
										<pl_arrival>											
											...
											<!-- mod by zzhao 2013-09-24 -->
												...
												<xsl:for-each select="FlightRoute">
													...
													<xsl:if
														test="IATARoute/IATAViaAirport or ICAORoute/ICAOViaAirport">
											...
											<xsl:for-each select="FlightData/OperationalDateTime">											
											   <!--add by zzhao  2014-05-08-->
												<xsl:if
													...
													<pa_stotoutstation>
													    <xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pa_arrival.pl_arrival.pa_stotoutstation</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
														</xsl:call-template>
														<xsl:call-template name="xsltTemplate">
															<xsl:with-param name="inElement"
								...
								<xsl:if
									test="$arrivalOrDepature='Departure' or $arrivalOrDepature='D' ">
									<pt_pd_departure>
									    <!--update by zzhao 2013-08-27  -->										
										<pl_departure>
											<!--<pd_modtime>
											...
											<xsl:for-each select="FlightData/General">			
												<xsl:if test="Registration">
													<pd_registration>
														<xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_registration</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
														</xsl:call-template>
														<xsl:call-template name="xsltTemplate">
															<xsl:with-param name="inElement" select="Registration" />
												...
												<xsl:for-each select="FlightRoute">
													<xsl:if
														test="IATARoute/IATANextAirport or ICAORoute/IATADestinationAirport or ../FlightCountryType">
														<pd_rap_nextairport>
															<xsl:value-of select="IATARoute/IATANextAirport" />														
														</pd_rap_nextairport>
													</xsl:if>
													<xsl:if
														test="IATARoute/IATANextAirport or ICAORoute/ICAODestinationAirport">
														...
														<!--  <xsl:variable name="counter" select="position()" />							                         							                         
														 ...
														 <xsl:choose>
														     <xsl:when test="$checkAirport!=$iataviaairport"> edited by Steven 2014.1.16-->
														      ...
														      <pl_routing>
														      <prt_rap_airport><xsl:value-of select="$iataviaairport" />														
														      </prt_rap_airport>															  
															  <prt_numberinleg><xsl:value-of select="position()" />
															  </prt_numberinleg>
														      </pl_routing>
											...
											<xsl:for-each select="FlightData/OperationalDateTime">
												<xsl:for-each select="OffBlockDateTime">
												    ...
												    <xsl:if test="ScheduledOffBlockDateTime">
												     <pd_sobt>
												     	<xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_sobt</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
														</xsl:call-template>
												      <xsl:call-template name="xsltTemplate">
														<xsl:with-param name="inElement"
													...
													<xsl:if test="EstimatedOffBlockDateTime">
														<pd_eobtlocal>
														<xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_eobtlocal</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
														</xsl:call-template>														
															<xsl:call-template name="xsltTemplate">
																<xsl:with-param name="inElement"
													...
													<xsl:if test="ActualOffBlockDateTime">
														<pd_aobt>
														<xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_aobt</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
														</xsl:call-template>
															<xsl:call-template name="xsltTemplate">
																<xsl:with-param name="inElement"
...
<!-- 												<xsl:if test="ScheduledTakeOffDateTime">
													...
													<xsl:if test="EstimatedTakeOffDateTime">
														<pd_etot>
														    <xsl:call-template name="addPriority">
															   <xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_etot</xsl:with-param>
															   <xsl:with-param name="sender" select="$sender" />
														    </xsl:call-template>
															<xsl:call-template name="xsltTemplate">
																<xsl:with-param name="inElement"
													...
													<xsl:if test="ActualTakeOffDateTime">
														<pd_atot>
														<xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_atot</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
														</xsl:call-template>														
															<xsl:call-template name="xsltTemplate">
																<xsl:with-param name="inElement"
										...
										<xsl:for-each select="NextAirportArrivalDateTime">
										  <xsl:if test="ActualNextAirportArrivalDateTime">
										    <pd_aldtnext>
										    <xsl:call-template name="addPriority">
												<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_aldtnext</xsl:with-param>
												<xsl:with-param name="sender" select="$sender" />
											</xsl:call-template>
										    <xsl:call-template name="xsltTemplate">
										   ...
										   <xsl:call-template name="xsltTemplate">
											...
											<xsl:for-each select="FlightData/Status">
												...
												<xsl:if test="OperationStatus">
													<pd_rrmk_remark>
														<xsl:call-template name="addPriority">
															<xsl:with-param name="key">pl_turn.pt_pd_departure.pl_departure.pd_rrmk_remark</xsl:with-param>
															<xsl:with-param name="sender" select="$sender" />
															</xsl:call-template>															
															<xsl:call-template name="xsltTemplate">
																<xsl:with-param name="inElement" select="OperationStatus" />
								...
								<xsl:if test="ResourceData/Closing">
									<xsl:for-each select="ResourceData/Closing">
										<rcl_beginplantime>
											<xsl:call-template name="xsltTemplate">
												<xsl:with-param name="inElement"
													select="ClosingScheduledFromDateTime" />
												<xsl:with-param name="needAddNil" select="true()"></xsl:with-param>
											</xsl:call-template>
										</rcl_beginplantime>
										<rcl_endplantime>
											<xsl:call-template name="xsltTemplate">
												<xsl:with-param name="inElement"
													select="ClosingScheduledEndDateTime" />
												<xsl:with-param name="needAddNil" select="true()"></xsl:with-param>
											</xsl:call-template>
										</rcl_endplantime>
										<rcl_beginactual>
											...
											<xsl:call-template name="xsltTemplate">
												<xsl:with-param name="inElement"
													select="ClosingActualFromDateTime" />
												<xsl:with-param name="needAddNil" select="true()"></xsl:with-param>
											</xsl:call-template>
										</rcl_beginactual>
										<rcl_endactual>
											...
											<xsl:call-template name="xsltTemplate">
												<xsl:with-param name="inElement"
													select="ClosingActualEndDateTime" />
												<xsl:with-param name="needAddNil" select="true()"></xsl:with-param>
											</xsl:call-template>
										</rcl_endactual>
										<rcl_reason>
						...
						<xsl:if test="PrimaryKey/GroundServiceDataKey">
							<xsl:for-each select="GroundServiceData">
								<xsl:for-each select="Service">
									<et_gs_service>
										<xsl:call-template name="actionMode">
											<xsl:with-param name="operationMode"
												select="../../../SysInfo/OperationMode" />
										</xsl:call-template>
										...
										<xsl:if test="ServiceScheduleStartDateTime">
											<serviceschedulestart>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="ServiceScheduleStartDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</serviceschedulestart>
										</xsl:if>
										<xsl:if test="ServiceScheduleEndDateTime">
											<servicescheduleend>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="ServiceScheduleEndDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</servicescheduleend>
										</xsl:if>
										<xsl:if test="ServiceActualStartDateTime">
											<serviceactualstart>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="ServiceActualStartDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</serviceactualstart>
										</xsl:if>
										<xsl:if test="ServiceActualEndDateTime">
											<serviceactualend>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="ServiceActualEndDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</serviceactualend>
										</xsl:if>
									...
									<et_gs_staff>
										...
										<xsl:if test="StaffScheduledOndutyDateTime">
											<staffscheduledonduty>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="StaffScheduledOndutyDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</staffscheduledonduty>
										</xsl:if>
										<xsl:if test="StaffScheduledOffdutyDateTime">
											<staffscheduledoffduty>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="StaffScheduledOffdutyDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</staffscheduledoffduty>
										</xsl:if>
										<xsl:if test="StaffActualOndutyDateTime">
											<staffactualonduty>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="StaffActualOndutyDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</staffactualonduty>
										</xsl:if>
										<xsl:if test="StaffActualOffdutyDateTime">
											<staffactualoffduty>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="StaffActualOffdutyDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</staffactualoffduty>
										</xsl:if>
									...
									<et_gs_task>
										...
										<xsl:if test="TaskScheduledStartDateTime">
											<taskskdstart>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskScheduledStartDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskskdstart>
										</xsl:if>
										<xsl:if test="TaskScheduledEndDateTime">
											<taskskdend>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskScheduledEndDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskskdend>
										</xsl:if>
										<xsl:if test="TaskScheduledMobileFacilityName">
											<taskskdmobilefacilityname>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskScheduledMobileFacilityName" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskskdmobilefacilityname>
										</xsl:if>
										...
										<xsl:if test="TaskScheduledMobileFacilityUsage">
											<taskskdmobilefacilityusage>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskScheduledMobileFacilityUsage" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskskdmobilefacilityusage>
										</xsl:if>
										...
										<xsl:if test="TaskScheduledExecutionSequence">
											<taskskdexecutionsequence>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskScheduledExecutionSequence" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskskdexecutionsequence>
										</xsl:if>
										...
										<xsl:if test="TaskScheduledStaffSkill">
											<taskskdstaffskill>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskScheduledStaffSkill" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskskdstaffskill>
										</xsl:if>
										<xsl:if test="TaskActualStartDateTime">
											<taskactstart>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskActualStartDateTime" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskactstart>
										</xsl:if>
										...
										<xsl:if test="TaskActualMobileFacilityName">
											<taskactmobilefacilityname>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskActualMobileFacilityName" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskactmobilefacilityname>
										</xsl:if>
										...
										<xsl:if test="TaskActualMobileFacilityUsage">
											<taskactmobilefacilityusage>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskActualMobileFacilityUsage" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskactmobilefacilityusage>
										</xsl:if>
										...
										<xsl:if test="TaskActualExecutionSequence">
											<taskactexecutionsequence>
												<xsl:call-template name="xsltTemplate">
													<xsl:with-param name="inElement"
														select="TaskActualExecutionSequence" />
													<xsl:with-param name="needAddNil" select="true()" />
												</xsl:call-template>
											</taskactexecutionsequence>
										</xsl:if>
	...
	<xsl:template name="xsltTemplate">
		...
		<xsl:if test="$inElement/@OldValue">
			<xsl:attribute name="old"><xsl:value-of
				select="$inElement/@OldValue" />
        	</xsl:attribute>
		</xsl:if>
		<xsl:choose>
	...
	<xsl:template name="resourceTypeConvert">
		...
		<xsl:if test="$resourceType='Stand'">RSTA</xsl:if>
		<xsl:if test="$resourceType='BaggageMakeup'">RDB</xsl:if>
		<xsl:if test="$resourceType='Gate'">RGT</xsl:if>
		<xsl:if test="$resourceType='CheckInDesk'">RCNT</xsl:if>
		<xsl:if test="$resourceType='BaggageReclaim'">RBB</xsl:if>
		<xsl:if test="$resourceType='BoardingBridge'">RAB</xsl:if>
	</xsl:template>
